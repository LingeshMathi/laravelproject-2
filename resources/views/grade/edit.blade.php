...
<div class="container mt-3 mb-3" id="body">
    <div class="row">
        ...
        <div class="col-sm-6 mt-4 mb-4 bg-light" id="rad">
            <h2 class="text-center mt-3 text-primary">Grade Edit</h2>

            <form action="/grades/{{ $grade->id }}" method="post" class="form">
                @csrf
                @method('put')
                <table style="width:100%;">
                    <div class="mt-4">
                        <tr>
                            ...
                            <td><input class="form-control" type="text" id="grade_name"
                                    name="grade_name"value="{{ $grade->grade_name }}"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control mt-2" type="text" id="grade_number" name="grade_number"
                                    value="{{ $grade->grade_number }}"></td>
                        </tr>
                        <tr>
                            <td><label class="col-form-label mt-2" for="text">Grade Group:</label></td>
                            <td><input class="form-control mt-2" type="text" id="grade_group"
                                    name="grade_group"value="{{ $grade->grade_group }}"></td>
                        </tr>
