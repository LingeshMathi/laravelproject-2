    ...
    <div class="container mt-3 mb-3" id="body">
        <div class="row">
            ...
            <div class="col-sm-6 mt-4 mb-4 bg-light" id="rad">
                <h2 class="text-center mt-3 text-primary">Subject Edit</h2>

                <form action="/subjects/{{ $subject->id }}" method="post" class="form">
                    @csrf
                    @method('put')
                    <table style="width:100%;">
                        <div class="mt-4">
                            <tr>
                                ...
                                <td><input class="form-control" type="text" id="subject_name"
                                        name="subject_name"value="{{ $subject->subject_name }}"></td>
                            </tr>
                            <tr>
                                ...
                                <td><input class="form-control mt-2" type="text" id="subject_index" name="subject_index"
                                        value="{{ $subject->subject_index }}"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input class="form-control mt-2" type="text" id="subject_number" name="subject_number"
                                        value="{{ $subject->subject_number }}"></td>
                            </tr>
                            <tr>
                                <td>

                                <td><label class="col-form-label mt-2" for="text">subject type:</label></td>
                                <td><input class="form-control mt-2" type="text" id="subject_type"
                                        name="subject_type"value="{{ $subject->subject_type }}"></td>
                            </tr>
