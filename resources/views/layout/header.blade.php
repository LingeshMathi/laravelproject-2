        ...
        <nav class="navbar navbar-hover navbar-expand-lg navbar-soft">
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="main_nav99">
                    <ul class="navbar-nav ml-auto ">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu animate fade-up">
                                <li><a class="dropdown-item icon-arrow" href="{{ route('blogdetails') }}"> Blog single
                                        detail
                                    </a></li>
                    ...
                    <!-- Search bar.// -->
                    <ul class="navbar-nav ">
                        <li class="nav-item search hidden-xs hidden-sm "> <a class="nav-link"
                                href="{{ route('error') }}">
                        ...
                        <ul class="navbar-nav ">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu dropdown-menu-left">
                                    <li><a class="dropdown-item" href="{{ route('blogdetails') }}">Blog details</a>
                                    </li>
